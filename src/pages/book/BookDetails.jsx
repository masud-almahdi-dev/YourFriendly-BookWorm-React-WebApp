                ...
                {!failed &&
                    <div>
                        <div className="flex justify-center gap-4 items-center lg:justify-start lg:items-start w-full rounded-lg overflow-hidden">
                            <img src={book.image} className="w-full lg:w-1/2 aspect-video object-cover rounded-lg overflow-hidden contrast-125 saturate-150 brightness-110" alt="" />
                            ...
                            <div>
                                <h2>DETAILS TITLE</h2>
                                <h2>DETAILS Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo, dicta reiciendis. Maiores excepturi quos laudantium omnis quaerat cupiditate minus fugit?</h2>
                            </div>
                        </div>
                        <div className="flex flex-col lg:flex-row items-center justify-center p-4 gap-4">
                        <button className="bg-yellow-400 px-4 py-2 rounded-md hover:saturate-50 hover:brightness-75 text-black">BORROW</button>
